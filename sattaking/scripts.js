...
!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : "function" == typeof define && define.amd
      ...
      : e((t.coreui = {}), t.jQuery, t.PerfectScrollbar);
})(this, function (t, e, r) {
  "use strict";
      ...
      o(function (t) {
        ...
        (w.inspectSource = function (t) {
          ...
          (t.exports = function (t, e, n, r) {
            ...
            i && (g(n, "name") || L(n, "name", e)),
              t[e] !== n &&
              (i && (g(n, o) || L(n, o, t[e] ? "" + t[e] : a.join(String(e)))),
                t === v
                  ? (t[e] = n)
                  : r
                    ? t[e]
  ...
  C("split", 2, function (i, o, a) {
    ...
    if (
      ...
      a = function (t, e) {
        ...
        for (
          m || (r = new RegExp("^" + d.source + "$(?!\\s)", s));
          (i = d.exec(n)) &&
          !(
            l < (o = i.index + i[0][g]) &&
            (c.push(n.slice(l, i.index)),
              !m &&
              1 < i[g] &&
              i[0].replace(r, function () {
                for (u = 1; u < arguments[g] - 2; u++)
                  void 0 === arguments[u] && (i[u] = void 0);
              }),
              1 < i[g] && i.index < n[g] && v.apply(c, i.slice(1)),
              (a = i[0][g]),
              (l = o),
              c[g] >= f)
          );
          ...
          d[y] === i.index && d[y]++;
        return (
          l === n[g] ? (!a && d.test("")) || c.push("") : c.push(n.slice(l)),
          c[g] > f ? c.slice(0, f) : c
        );
      };
    } else
  ...
  var q,
    ...
    Z = ((q = !1),
      function (t, e, n) {
        ...
        if (q && e != e) {
          for (; c < u;) if ((o = a[c++]) != o) return !0;
        } else
          for (; c < u; c++) if ((q || c in a) && a[c] === e) return q || c || 0;
        return !q && -1;
      }),
    tt = X("IE_PROTO"),
    ...
    rt = n
      ...
      : function (t, e) {
        a(t);
        for (var n, r = nt(e), i = r.length, o = 0; o < i;)
          p.f(t, (n = r[o++]), e[n]);
        return t;
      },
    it = v.document,
    ...
    lt =
      ...
      function (t, e) {
        ...
        return (
          null !== t
            ? ((ut[ct] = a(t)), (n = new ut()), (ut[ct] = null), (n[at] = t))
            : (n = st()),
          void 0 === e ? n : rt(n, e)
        );
      },
    ...
    pt = function (t, e, n) {
      t &&
        !g((t = n ? t : t.prototype), dt) &&
        ft(t, dt, { configurable: !0, value: e });
    },
    ht = {};
  ...
  var vt = function (t) {
    ...
    Lt = function (t, e, n, r, i, o, a) {
      ...
      (c = e),
        (s = r),
        ((u = n).prototype = lt(ht, { next: _(1, s) })),
        pt(u, c + " Iterator");
      var l,
        f,
        d,
      ...
      if (
        (S &&
          (d = mt(S.call(new t()))) !== Object.prototype &&
          d.next &&
          (pt(d, h, !0), "function" != typeof d[bt] && L(d, bt, _t)),
          v &&
          m &&
          m.name !== St &&
          ((g = !0),
        ...
        if (
          ((l = { values: v ? b : p(St), keys: o ? b : p("keys"), entries: w }),
            a)
        )
    ...
    Ot = Lt(
      ...
      function () {
        ...
        return !t || n >= t.length
          ? ((this._t = void 0), M(1))
          : M(0, "keys" == e ? n : "values" == e ? t[n] : [n, t[n]]);
      },
      "values"
    );
  ...
  for (
    ...
    if (
      Mt &&
      (Mt[Tt] || L(Mt, Tt, Ct), Mt[It] || L(Mt, It, At), (R[At] = Ct), Pt)
    )
  ...
  var Rt = { f: Object.getOwnPropertySymbols },
    ...
    Qt =
      !Gt ||
        ...
        ? function (t, e) {
          for (
            var n = vt(t), r = arguments.length, i = 1, o = Rt.f, a = Nt.f;
            i < r;
            ...
            for (
              var u,
              c = N(arguments[i++]),
              s = o ? nt(c).concat(o(c)) : nt(c),
              l = s.length,
              f = 0;
              f < l;

            )
              a.call(c, (u = s[f++])) && (n[u] = c[u]);
          return n;
        }
        : Gt;
  V(V.S + V.F, "Object", { assign: Qt });
  var Ut,
    Ft = ((Ut = !0),
      function (t, e) {
        var n,
  ...
  Lt(
    ...
    function () {
      ...
      return n >= e.length
        ? { value: void 0, done: !0 }
        : ((t = Ft(e, n)), (this._i += t.length), { value: t, done: !1 });
    }
  );
    ...
    "Array",
    {
      from: function (t) {
        var e,
          ...
          d = $t(a);
        if (
          (l && (s = Q(s, 2 < c ? arguments[2] : void 0, 2)),
            null != d &&
            (u != Array ||
              (void 0 === (o = d) || (R.Array !== o && Kt[Vt] !== o))))
        )
          for (i = d.call(a), n = new u(); !(r = i.next()).done; f++)
            Ht(n, f, l ? qt(i, s, [r.value, f], !0) : r.value);
        else
          for (n = new u((e = J(a.length))); f < e; f++)
            Ht(n, f, l ? s(a[f], f) : a[f]);
        return (n.length = f), n;
      }
    }
  ),
  ...
  var te,
    ...
    Ae = ((ee = "ajaxLoad"),
      ...
      (ae = "view-script"),
      (ue = "click"),
      (ce = ".sidebar-nav .nav-dropdown"),
      (se = ".sidebar-nav .nav-link"),
      (le = ".sidebar-nav .nav-item"),
      (fe = ".view-script"),
      (de = {
      ...
      (pe = (function () {
        ...
        return (
          ...
          (t.setUpUrl = function (t) {
            te(se).removeClass(ie),
              te(ce).removeClass(oe),
              te(
                ce + ':has(a[href="' + t.replace(/^\//, "").split("?")[0] + '"])'
              ).addClass(oe),
              te(
                le + ' a[href="' + t.replace(/^\//, "").split("?")[0] + '"]'
              ).addClass(ie),
              this.loadPage(t);
          }),
      ...
      (te.fn[ee] = pe._jQueryInterface),
      (te.fn[ee].Constructor = pe),
    ...
    De = ((ve = "aside-menu"),
          ...
          (n.prototype._addEventListeners = function () {
            he(document).on(me.CLICK, we, function (t) {
              ...
              var e = t.currentTarget.dataset
                ...
                : he(t.currentTarget).data("toggle");
              Pe(e, Se);
            });
          }),
      ...
      (he.fn[ve] = _e._jQueryInterface),
      (he.fn[ve].Constructor = _e),
      (he.fn[ve].noConflict = function () {
        ...
        function (t, e) {
          return (
            ...
            ("function" != typeof (r = n.constructor) ||
              (r !== Array && !Me(r.prototype)) ||
              (r = void 0),
              i(r) && null === (r = r[Re]) && (r = void 0)),
  ...
  var Ue,
    ...
    dn = ((Fe = "sidebar"),
      ...
      (We = "body"),
      (Ye = ".brand-minimizer"),
      (Xe = ".nav-dropdown-toggle"),
      (Ze = ".nav-dropdown-items"),
      (tn = ".nav-item"),
      (en = ".nav-link"),
      (nn = ".nav-link-queried"),
      (rn = ".sidebar-nav"),
        ...
        return (
          (t.perfectScrollbar = function (t) {
            ...
            if ("undefined" != typeof r) {
              ...
              t !== $e.INIT || n.contains(Je) || (this.ps = this.makeScrollbar()),
                t === $e.DESTROY && this.destroyScrollbar(),
                t === $e.TOGGLE &&
                (n.contains(Je)
            ...
            Ue(document).on($e.CLICK, Ye, function (t) {
              ...
              Ue(document).on($e.CLICK, Xe, function (t) {
                ...
                Ue(e)
                  .parent()
                  .toggleClass(ze),
                  n.perfectScrollbar($e.UPDATE);
              }),
              Ue(document).on($e.CLICK, un, function (t) {
                t.preventDefault(),
                  t.stopPropagation(),
                  Ue(We).toggleClass(Je),
                  n.perfectScrollbar($e.TOGGLE);
              }),
              Ue(document).on($e.CLICK, cn, function (t) {
                t.preventDefault(), t.stopPropagation();
                var e = t.currentTarget.dataset
                  ? t.currentTarget.dataset.toggle
                  : Ue(t.currentTarget).data("toggle");
                Pe(e, sn), n._toggleClickOut();
              }),
              Ue(on + " > " + tn + " " + en + ":not(" + Xe + ")").on(
                $e.CLICK,
                function () {
                  n._removeClickOut(),
                    document.body.classList.remove("sidebar-show");
      ...
      (Ue.fn[Fe] = ln._jQueryInterface),
      (Ue.fn[Fe].Constructor = ln),
  ...
  n &&
    "g" != /./g.flags &&
    p.f(RegExp.prototype, "flags", { configurable: !0, get: pn });
  var hn = "toString",
    vn = /./[hn],
    gn = function (t) {
